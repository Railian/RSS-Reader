...
- (void)prepareNavigationControllerFrom:(UIViewController *)from to:(UIViewController *)to{
    if ([from isKindOfClass:[AppleNewsTableController class]]) {
        UINavigationController *navigationController = [[UINavigationController alloc] initWithRootViewController:from];
        _window.rootViewController = navigationController;
    }else  if ([from isKindOfClass:[AppleNewsDetailedController class]]) {
        _window.rootViewController = to;
    }
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.raylyan.RSS_Reader" in the application's documents directory.
